    ...
    class XpertoCustomOrgAdminNavWalker extends Walker_Nav_Menu
    {
        function start_el(&$output, $item, $depth = 0, $args = [], $id = 0)
        {
            ...
            if ($item->url && $item->url != '#') {
                ...
                if (in_array('menu-org-admin-edit-info', $css_classes)) {
                ...
                if (in_array('menu-org-admin-edit-membertypes', $css_classes)) {
                    $output .= '<svg class="' . $tw_img_css . '" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                if (in_array('menu-org-admin-edit-members', $css_classes)) {
                    $output .= '<svg class="' . $tw_img_css . '" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                if (in_array('menu-org-admin-view-reports', $css_classes)) {
                    $output .= '<svg class="' . $tw_img_css . '" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
