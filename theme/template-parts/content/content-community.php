...
<article id="post-<?php the_ID(); ?>" <?php post_class('bg-white flex flex-col rounded-lg xl:flex-row xl:rounded-none w-full'); ?>>
    ...
    if(has_post_thumbnail()):
        ...
        ?>
    <a href="<?php the_permalink(); ?>" class="<?php echo $attr['class']; ?> flex flex-col justify-center items-center bg-gradient-to-t from-xperto-orange to-xperto-orange-base-20">
