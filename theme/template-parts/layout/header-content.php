		...
		<div class="flex justify-between items-center md:justify-end">
			...
			<?php if (is_user_logged_in()) : ?>
				<div id="nav-menu" class="flex items-center self-end space-x-6">
					...
					<!-- notification -->
					<div class="relative inline-block rounded-lg px-4 py-2 group cursor-pointer hover:bg-xperto-orange-light-90">
						<a href="#" id="user-menu" class="flex items-center space-x-3 text-xperto-orange font-bold">
							<?php
