            ...
            <section id="membership-upgrade-content" class="w-full">
                <div class="flex flex-row rounded-lg bg-xperto-success-light-80 border border-xperto-success-base p-6 relative">
                    <div class="flex flex-col space-y-4 w-full">
                        ...
                        <a class="rounded-lg bg-xperto-orange py-3 px-4 text-white flex-none w-full text-center md:w-48 hover:bg-xperto-orange-base-20 active:bg-xperto-orange-base-plus-10" href="<?php echo home_url('?loginaction=xpertoOauthLogin'); ?>">Become a member</a>
                    </div>
                </div>
            </section>
<?php endif;
