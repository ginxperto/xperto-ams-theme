<section id="membership-upgrade-content" class="w-full">
    <div class="flex flex-row rounded-lg bg-xperto-success-light-80 border border-xperto-success-base p-6">
        <div class="flex flex-col w-full space-y-4">
            ...
            <a class="rounded-lg bg-transparent py-3 px-4 text-xperto-orange flex-none w-full text-center border border-xperto-orange hover:bg-xperto-orange-base-20 hover:text-white active:bg-xperto-orange-base-plus-10 focus:outline-none" href="http://localhost/dev/wordpress-theme-sbx/register/basic-bundle/">Upgrade Membership</a>
        </div>
    </div>
